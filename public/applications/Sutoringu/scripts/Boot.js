...
(function () {
    ...
    Sutoringu.Boot.prototype = {
        preload: function () {
            this.game.load.image('favicon', 'Sutoringu/assets/images/favicon.ico', 256, 256);
            this.game.load.image('floor', 'Sutoringu/assets/images/floor.png');
            this.game.load.spritesheet('button', 'Sutoringu/assets/images/button.png', 384, 64);
            this.game.load.spritesheet('scoreChart', 'Sutoringu/assets/images/scoreChart.png', 64, 64, 6);
        },
        create: function () {
